...
class SNOMActionGateway {
  ...
  Map<String, String> get actionUrls => {
        SNOMActionURL.KEY_ACTION_AXFR: '${this.host}${SNOMActionURL.AXFR}'
            '?${SNOMActionURL.UserKV}'
            '&${SNOMActionURL.CallIDKV}',
        SNOMActionURL.KEY_ACTION_BXFR: '${this.host}${SNOMActionURL.BXFR}'
            '?${SNOMActionURL.UserKV}'
            '&${SNOMActionURL.CallIDKV}',
        SNOMActionURL.KEY_ACTION_CONN: '${this.host}${SNOMActionURL.CONN}'
            '?${SNOMActionURL.UserKV}'
            '&${SNOMActionURL.CallIDKV}',
        SNOMActionURL.KEY_ACTION_DISCONN: '${this.host}${SNOMActionURL.DISCONN}'
            '?${SNOMActionURL.UserKV}'
            '&${SNOMActionURL.CallIDKV}',
        SNOMActionURL.KEY_ACTION_DND_OFF: '${this.host}${SNOMActionURL.DND_OFF}'
            '?${SNOMActionURL.UserKV}',
        SNOMActionURL.KEY_ACTION_DND_ON: '${this.host}${SNOMActionURL.DND_ON}'
            '?${SNOMActionURL.UserKV}',
        SNOMActionURL.KEY_ACTION_HOLD: '${this.host}${SNOMActionURL.HOLD}'
            '?${SNOMActionURL.UserKV}'
            '&${SNOMActionURL.CallIDKV}',
        SNOMActionURL.KEY_ACTION_UNHOLD: '${this.host}${SNOMActionURL.UNHOLD}'
            '?${SNOMActionURL.UserKV}'
            '&${SNOMActionURL.CallIDKV}',
        ...
        SNOMActionURL.KEY_ACTION_LOG_OFF: '${this.host}${SNOMActionURL.LOG_OFF}'
            '?${SNOMActionURL.UserKV}',
        SNOMActionURL.KEY_ACTION_LOG_ON: '${this.host}${SNOMActionURL.LOG_ON}'
            '?${SNOMActionURL.UserKV}',
        SNOMActionURL.KEY_ACTION_MISSED: '${this.host}${SNOMActionURL.MISSED}'
            '?${SNOMActionURL.UserKV}',
        SNOMActionURL.KEY_ACTION_HOOK_OFF:
            '${this.host}${SNOMActionURL.HOOK_OFF}'
            '?${SNOMActionURL.UserKV}',
        SNOMActionURL.KEY_ACTION_HOOK_ON: '${this.host}${SNOMActionURL.HOOK_ON}'
            '?${SNOMActionURL.UserKV}',
        ...
        SNOMActionURL.KEY_ACTION_SETUP_DONE:
            ...
            '?${SNOMActionURL.UserKV}',
        SNOMActionURL.KEY_ACTION_XFR: '${this.host}${SNOMActionURL.XFR}'
            '?${SNOMActionURL.UserKV}'
            '&${SNOMActionURL.CallIDKV}',
      };
  ...
  Response callOutgoing(Request request) {
    this.phones[SNOMparameters.user(request)]._addEvent(new CallOutgoing(
  ...
  Response dnd(Request request) {
    ...
    this.phones[SNOMparameters.user(request)]._addEvent(new DND(dnd));
  ...
  Response callInvite(Request request) {
    this.phones[SNOMparameters.user(request)]._addEvent(new CallInvite(
        SNOMparameters.callID(request), SNOMparameters.callee(request)));
  ...
  Response callIncoming(Request request) {
    this.phones[SNOMparameters.user(request)]._addEvent(new CallIncoming(
        SNOMparameters.callID(request), SNOMparameters.callee(request)));
  ...
  Response get(Request request) => new Response.ok(
      JSON.encode(this.phones[route.getPathParameters(request)['id']]));

  Response list(Request request) => new Response.ok(JSON.encode(this.phones));
}
...
abstract class SNOM {
  ...
  static const String VAR_CONTEXT_URL =
      '\$context_url'; // used in log_on/off-action
  static const String VAR_CANCEL_REASON =
      '\$cancel_reason'; // reason-header for cancel/hangup
}
...
abstract class SNOMActionURL {
  ...
  static const String CalleeKV =
      '${SNOM.PARAM_CALLEE}=${SNOM.VAR_REMOTE_SIP_URI}';
  ...
  static const String KEY_ACTION_RECV_AXFR =
